...
export class World {
    ...
    constructor(worldScenePath?: any) {
        ...
        this.camera = new THREE.PerspectiveCamera(80, window.innerWidth / window.innerHeight, 0.1, 20010);
    ...
    public updatePhysics(timeStep: number): void {
        ...
        this.characters.forEach((char) => {
            if (this.isOutOfBounds(char.characterCapsule.body.position)) {
                ...
                //if (char.charState.constructor.name !== 'SwimIdle') {
                //char.setState(new SwimIdle(char));
                //}
            }
        });
